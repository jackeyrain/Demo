...
{
    internal partial class BANodeManager : BaseNodeManager
    {
        #region Constructor
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        public BANodeManager(ServerManager server) : base(server)
        {
        }
        #endregion
        ...
        public override void Startup()
        {
            try
            {
                Console.WriteLine("Starting BANodeManager.");

                DefaultNamespaceIndex = AddNamespaceUri("http://yourorganisation.org/BuildingAutomation/");

                Console.WriteLine("Loading the BA Model.");
                ImportUaNodeset(Assembly.GetEntryAssembly(), "buildingautomation.xml");

            }
            catch (Exception e)
            {
                Console.WriteLine("Failed to start BANodeManager " + e.Message);
            }
        }
        ...
        public override void Shutdown()
        {
            try
            {
                Console.WriteLine("Stopping BANodeManager.");

                // TBD
            }
            catch (Exception e)
            {
                Console.WriteLine("Failed to stop BANodeManager " + e.Message);
            }
        }
        #endregion
